...
- **The stop's Step 5 flush is a `tcdrain`** (deferred from `kerf-fence-reopen`, critic A12).
  ...
  predates this relay, and the in-flight re-send copies it deliberately. The next batch that
  touches the stop picks it up.
