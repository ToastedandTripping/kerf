---
status: active
current: v0.8.7 released 2026-06-20 — speed unit → mm/min (canonical) + S-Value Max ($30) calibration (relay kerf-speed-mmmin). Shipped without on-hardware verification per owner decision (sole user, off-Mac); a 480 mm/min @ 60% confidence cut is recommended before the next real job.
next: v0.9 — Machine-limit / motor-protection safety audit (out-of-bounds move prevention), then Camera & Rotary
testing: null
pinned: true
shipped:
  - date: 2026-06-20
