...
function getCommands(): Command[] {
  ...
  return [
    // File
    {
      ...
      shortcut: "Ctrl+N",
      category: "File",
      action: () => fileOperations.newProject(),
    },
    {
      id: "file-open",
      label: "Open Project",
      shortcut: "Ctrl+O",
      category: "File",
      action: () => fileOperations.openProject(),
    },
    {
      id: "file-save",
      label: "Save",
      shortcut: "Ctrl+S",
      category: "File",
      action: () => fileOperations.saveProject(),
    },
    {
      id: "file-saveas",
      label: "Save As",
      ...
      category: "File",
      action: () => fileOperations.saveProjectAs(),
    },
    {
      id: "file-import-svg",
      label: "Import SVG",
      category: "File",
      action: () => fileOperations.importSvg(),
    },
    {
      id: "file-import-dxf",
      label: "Import DXF",
      category: "File",
      action: () => fileOperations.importDxf(),
    },
    {
      id: "file-import-image",
      label: "Import Image",
      category: "File",
      action: () => fileOperations.importImage(),
    },
    {
      id: "file-export-svg",
      label: "Export SVG",
      category: "File",
      action: () => fileOperations.exportSvg(),
    },
    {
      id: "file-export-gcode",
      label: "Save G-code",
      category: "File",
      action: () => fileOperations.exportGcode(),
    },
    ...
    },
    {
      ...
      action: () => {
        ...
        for (const id of store.selectedIds) {
          ...
          if (obj?.type === "text") {
            store.convertTextToPath(id);
          } else {
            store.convertToPath(id);
          }
        }
      },
    },
    ...
    // View
    {
      ...
      shortcut: "G",
      category: "View",
      action: () => s().setGridVisible(!s().gridVisible),
    },
    {
      id: "view-snap",
    ...
    },
    {
      ...
      shortcut: "Ctrl+U",
      category: "Arrange",
      action: () => s().ungroupSelected(),
    },
    {
      id: "arr-align-left",
      label: "Align Left",
      category: "Arrange",
      action: () => s().alignObjects("left"),
    },
    {
      id: "arr-align-right",
      label: "Align Right",
      category: "Arrange",
      action: () => s().alignObjects("right"),
    },
    {
      id: "arr-align-top",
      label: "Align Top",
      category: "Arrange",
      action: () => s().alignObjects("top"),
    },
    {
      id: "arr-align-bottom",
      label: "Align Bottom",
      category: "Arrange",
      action: () => s().alignObjects("bottom"),
    },
    {
      id: "arr-align-hcenter",
      label: "Align H-Center",
      category: "Arrange",
      action: () => s().alignObjects("hcenter"),
    },
    {
      id: "arr-align-vcenter",
      label: "Align V-Center",
      category: "Arrange",
      action: () => s().alignObjects("vcenter"),
    },
    {
      id: "arr-dist-h",
      label: "Distribute Horizontal",
      category: "Arrange",
      action: () => s().distributeObjects("horizontal"),
    },
    {
      id: "arr-dist-v",
      label: "Distribute Vertical",
      category: "Arrange",
      action: () => s().distributeObjects("vertical"),
    },
    {
      id: "arr-flip-h",
    ...
    },
    {
      ...
      action: () => {
        const store = s();
        store.withUndo("lock", () => {
          for (const id of store.selectedIds) store.updateObject(id, { locked: true });
    ...
    // Boolean / Tools
    {
      ...
      label: "Boolean Union",
      category: "Tools",
      action: () => s().booleanUnion(),
    },
    {
      id: "bool-diff",
      label: "Boolean Difference",
      category: "Tools",
      action: () => s().booleanDifference(),
    },
    {
      id: "bool-intersect",
      label: "Boolean Intersection",
      category: "Tools",
      action: () => s().booleanIntersection(),
    },
    { id: "bool-xor", label: "Boolean XOR", category: "Tools", action: () => s().booleanXor() },
    {
      id: "tool-offset-out",
      label: "Offset Outward (+1mm)",
      category: "Tools",
      action: () => s().offsetPaths(1),
    },
    {
      id: "tool-offset-in",
      label: "Offset Inward (-1mm)",
      category: "Tools",
      action: () => s().offsetPaths(-1),
    },
    {
    ...
    { id: "tool-settings", label: "Preferences", category: "Tools", action: () => openSettings() },
    {
      ...
      label: "Project Notes",
      category: "Tools",
      action: () => openProjectNotes(),
    },
    {
      id: "tool-variable-text",
      label: "Variable Text",
      category: "Tools",
      action: () => openVariableText(),
    },
